...
outputDir='/eos/uscms/store/user/snowmass/noreplica/DelphesFromLHE_333pre16_2016Aug/' 
condorDir='/uscms_data/d3/jmanagan/DelphesFromLHE_333pre16_2016Aug_logs/' # Change username, match log directory to the ROOT file directory
