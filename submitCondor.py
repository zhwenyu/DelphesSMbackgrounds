...
inputDir='/eos/uscms/store/user/snowmass/HTBinned_LHEfiles/14TEV/'  # DO NOT CHANGE
outputDir='/eos/uscms/store/user/snowmass/noreplica/DelphesFromLHE_333pre16_2016Aug/' #DO NOT CHANGE
condorDir='/uscms_data/d3/jmanagan/DelphesFromLHE_333pre16_2016Aug/' # CHANGE THIS
...
for sample in dirList:
    ...
    skip = False
    if count+len(lhefiles) > 10000: 
        print 'SKIPPING '+sample+', more than 10K jobs'  # OPTIONAL TO SUBMIT IN CHUNKS
        continue
